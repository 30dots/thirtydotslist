...
const MainLayout = ({ children }) => {
  ...
  return (
    <div className={style.layout}>
      <Helmet titleTemplate="CardanoList | %s" title="Curated list of Cardano projects by Ray Network">
        ...
        <meta
          name="description"
          content="CardanoList - Curated list of Cardano projects by Ray Network"
        />
      </Helmet>
      <div>
        <Menu />
